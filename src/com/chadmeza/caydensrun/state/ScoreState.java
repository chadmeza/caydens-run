...
public class ScoreState extends State {
	...
	private Bitmap bg, title, touch, num0, num1, num2, num3, num4, num5, num6, num7, num8, num9;
	
	@Override
	public void onLoad() {
		bg = Assets.loadBitmap("bg_highscore.png", false);
		title = Assets.loadBitmap("title_highscore.png", true);
	...
	private void renderScore(Painter g) {
		startX = 400 - ((highScore.length() * 38) / 2);
		
		for (int i = 0; i < highScore.length(); i++) {
			numberPlaceholder = Integer.parseInt(String.valueOf(highScore.charAt(i)));
